...
#for entry in glob('data/next/Belek.xlsx'):
#    with open(entry, 'r') as f:
#        df = pd.read_excel(entry, sheet_name='Tabelle1')
#
...
with open(filename) as f:
    ...
    for line in df:
        ...
        #print (df.head())
    df.to_csv('data//next/Belek_Versuch_1.csv', header=True, index=False, encoding='utf-8-sig')
    #print(df.head())
